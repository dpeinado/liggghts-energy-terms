...
PairStyle(gran/hooke/history/energy,PairGranHookeHistoryEnergy)

#else

#ifndef LMP_PAIR_GRAN_HOOKE_HISTORY_ENERGY_H
#define LMP_PAIR_GRAN_HOOKE_HISTORY_ENERGY_H

#include "pair_gran.h"

namespace LAMMPS_NS {

class PairGranHookeHistoryEnergy : public PairGran {

 friend class FixWallGranHookeHistoryEnergy;
 friend class FixCheckTimestepGran;

 public:

  PairGranHookeHistoryEnergy(class LAMMPS *);
  ~PairGranHookeHistoryEnergy();
