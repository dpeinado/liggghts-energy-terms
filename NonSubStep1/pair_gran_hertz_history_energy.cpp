...
PairGranHertzHistoryEnergy::PairGranHertzHistoryEnergy(LAMMPS *lmp) : PairGran(lmp)
{
...
PairGranHertzHistoryEnergy::~PairGranHertzHistoryEnergy()
{
...
void PairGranHertzHistoryEnergy::updatePtrs()
{
...
void PairGranHertzHistoryEnergy::history_args(char** args)
{
...
inline void PairGranHertzHistoryEnergy::addCohesionForce(int &ip, int &jp,double &r, double &Fn_coh)
{
...
//    printf("\n************************************\n");
    ...
    kn /= force->nktv2p;
    kt /= force->nktv2p;
    epK = 0.20; // this is 2/5 because the integration from x^3/2, and 1/2 because 2 particles.
    return;
}
...
void PairGranHertzHistoryEnergy::compute(int eflag, int vflag, int addflag)
{
...
void PairGranHertzHistoryEnergy::settings(int narg, char **arg)
{
...
void PairGranHertzHistoryEnergy::allocate_properties(int size)
{
...
void PairGranHertzHistoryEnergy::write_restart_settings(FILE *fp)
{
...
void PairGranHertzHistoryEnergy::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
