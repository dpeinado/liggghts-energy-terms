...
#include "stdlib.h"
#include "string.h"
#include "pair_gran_hertz_history_energyNS1.h"
#include "atom.h"
#include "atom_vec.h"
#include "domain.h"
#include "force.h"
...
PairGranHertzHistoryEnergyNS1::PairGranHertzHistoryEnergyNS1(LAMMPS *lmp) : PairGranHookeHistoryEnergyNS1(lmp)
{
...
inline void PairGranHertzHistoryEnergyNS1::deriveContactModelParams(int &ip, int &jp,double &meff,double &deltan, double &kn, double &kt, double &gamman, double &gammat, double &xmu, double &rmu,double &epK)
{
...
void PairGranHertzHistoryEnergyNS1::init_substyle()
{
