...
PairGranHertzIncrementalEnergyNS2::PairGranHertzIncrementalEnergyNS2(LAMMPS *lmp) : PairGranHertzIncrementalEnergy(lmp)
{
...
void PairGranHertzIncrementalEnergyNS2::compute(int eflag, int vflag, int addflag)
{
