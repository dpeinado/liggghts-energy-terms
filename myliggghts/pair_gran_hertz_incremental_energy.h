...
PairStyle(gran/hertz/incremental/energy,PairGranHertzIncrementalEnergy)

#else

#ifndef LMP_PAIR_GRAN_HERTZ_INCREMENTAL_ENERGY_H
#define LMP_PAIR_GRAN_HERTZ_INCREMENTAL_ENERGY_H

#include "pair_gran.h"

namespace LAMMPS_NS {

class PairGranHertzIncrementalEnergy : public PairGran {
 ...
 public:
  ...
  PairGranHertzIncrementalEnergy(class LAMMPS *);
  ~PairGranHertzIncrementalEnergy();
