...
void FixCfdCoupling::init()
{
  ...
  for(int ifix = 0; ifix < modify->nfix; ifix++)
  {
        if(strncmp("couple/cfd",modify->fix[ifix]->style,10) == 0)
        {
            ...
            else if(comm->me == 0) fprintf(screen,"INFO: More than one fix of type couple/cfd defined. Please note that the first of them controlls the frequency of data exchange");
        }
  }
...
{
      dc->allocate_external(data,len2,len1,initvalue);
}
