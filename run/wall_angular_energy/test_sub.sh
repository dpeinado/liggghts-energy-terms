...
do
	...
	pair_coeff		* *
	fix				zwall all wall/${model} 0 zplane 0 NULL 1 #wiggle z 0.1 6.0e-2	
	...
	run			    5000 upto		
EOF
python ~/liggghts-energy-terms/pyPost/pyGRAPH.py files/dump-${rootName}.${a} files/${rootName}_${a}_ files/energy-${rootName}.${a}.csv
