...
set grid 
plot [0:4500] [-10:60] "files/${2}2.dat" using 1:2 title "kE" with lp ls 1, "files/${2}2.dat" using 1:3 title "kR" with lp ls 2,"files/${2}2.dat" using 1:4 title "peN" with lp ls 3,"files/${2}2.dat" using 1:5 title "peT" with lp ls 4, "files/${2}2.dat" using 1:6 title "DeN" with lp ls 5,"files/${2}2.dat" using 1:7 title "DeTV" with lp ls 6,"files/${2}2.dat" using 1:8 title "DeTF" with lp ls 12,"files/${2}2.dat" using 1:9 title "TWF" with lp ls 7,"files/${2}2.dat" using 1:10 title "DEH" with lp ls 8, "files/${2}2.dat" using 1:11 title "ECons" with lp ls 9, "files/${2}2.dat" using 1:12 title "ETot" with lp ls 10
EOF
